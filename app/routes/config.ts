...
const configUpdateSchema = z.object({
  ...
  ynabDefaultAccount: z.string().max(NAME_MAX).optional(),
  actualAccountId: z.string().max(NAME_MAX).optional(),
  actualDefaultAccount: z.string().max(NAME_MAX).optional(),
  ...
  ynabHiddenAccounts: z.array(z.string().max(NAME_MAX)).max(256).optional(),
  actualHiddenAccounts: z.array(z.string().max(NAME_MAX)).max(256).optional(),
